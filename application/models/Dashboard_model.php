...
class Dashboard_model extends CI_Model{
    function showalldata()
    {
        ...
        {  
            switch($row->function){
                case 'Property_Transfer_Record': $data['pro_overall_amt'] = $row->amt;
                                                break;
                case 'Inheritance_Certificate': $data['inh_overall_amt'] = $row->amt;
                                                break;                                
                case 'Fire_Fighting_No_Objection_Certificate': $data['ffn_overall_amt'] = $row->amt;
                                                break;
                case 'Occupation_Certificate': $data['occ_overall_amt'] = $row->amt;
                                                break;                                
                case 'Part_Certificate': $data['part_overall_amt'] = $row->amt;
                                                break;
                case 'Zone_Certificate': $data['zone_overall_amt'] = $row->amt;
                                                break;                                
                case 'Construction_Certificate': $data['const_overall_amt'] = $row->amt;
                                                break;
                case 'Plant_Certificate': $data['plant_overall_amt'] = $row->amt;
                                                break;                                
                case 'Fire_Fighting': $data['ff_overall_amt'] = $row->amt;
                                                break;
                case 'Outstanding_Certificate': $data['out_overall_amt'] = $row->amt;
                                                break;                                
                case 'No Objection_Certificate': $data['noc_overall_amt'] = $row->amt;
                                                break;
                case 'Resident_Certificate': $data['res_overall_amt'] = $row->amt;
                                                break;                                
                case 'Birth_Registration': $bd_overall_amt = $bd_overall_amt + $row->amt;
                                                break;                               
                case 'Death_Registration': $bd_overall_amt = $bd_overall_amt + $row->amt;
                                                break;                               
            }
        }      
        ...
        {  
            switch($row->function){
                case 'Property_Transfer_Record': $data['pro_today_amt'] = $row->amt;
                                                break;
                case 'Inheritance_Certificate': $data['inh_today_amt'] = $row->amt;
                                                break;                                
                case 'Fire_Fighting_No_Objection_Certificate': $data['ffn_today_amt'] = $row->amt;
                                                break;
                case 'Occupation_Certificate': $data['occ_today_amt'] = $row->amt;
                                                break;                                
                case 'Part_Certificate': $data['part_today_amt'] = $row->amt;
                                                break;
                case 'Zone_Certificate': $data['zone_today_amt'] = $row->amt;
                                                break;                                
                case 'Construction_Certificate': $data['const_today_amt'] = $row->amt;
                                                break;
                case 'Plant_Certificate': $data['plant_today_amt'] = $row->amt;
                                                break;                                
                case 'Fire_Fighting': $data['ff_today_amt'] = $row->amt;
                                                break;
                case 'Outstanding_Certificate': $data['out_today_amt'] = $row->amt;
                                                break;                                
                case 'No Objection_Certificate': $data['noc_today_amt'] = $row->amt;
                                                break;
                case 'Resident_Certificate': $data['res_today_amt'] = $row->amt;
                                                break;                                
                case 'Birth_Registration': $bd_today_amt = $bd_today_amt + $row->amt;
                                                break;     
                case 'Death_Registration': $bd_today_amt = $bd_today_amt + $row->amt;
                                                break;                           
            }
        } 
