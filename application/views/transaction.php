                                ...
                                <div class="section_header"><span class="fa fa-exchange"> Transaction Master</span>
                                    ...
                                    <ul class="panel-controls">
                                        <li> <button class="btn btn-success btnhideshow"
                                                style="background-color:#33414e;margin-right:10px"><i
                                                    class="fa fa-plus"></i> Add Detail</button></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="section_header"><span class="fa fa-exchange"> Transaction Master</span>
                                    <div class="pull-right">
                                        <button class="btn btn-success closehideshow"
                                            style="background-color:#33414e;margin-right:10px"><i class="fa fa-eye"></i>
                                            View Detail</button></div>
                                </div>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form class="form-horizontal" id="master_form" name="master_form">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-sm-6">
                                                        <label>News/Advt. Size*</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control " id="codesize"
                                                            name="codesize" required>
