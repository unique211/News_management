   ...
   <script src="<?php echo base_url();?>assets/datatable/datatables-responsive/js/responsive.bootstrap.js"></script>
        ...
        <!-- <script type="text/javascript" src="<?php echo base_url() ?>assets/js/project_chart.js"></script> -->
        <!-- THIS PAGE PLUGINS -->
        <!-- <script type="text/javascript" src="<?php echo base_url() ?>assets/js/plugins/sparkline/jquery.sparkline.js"></script> -->
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>assets/js/actions.js"></script>
		...
		<script type="text/javascript" src="<?php echo base_url() ?>assets/select2/fstdropdown.js"></script>
<!-- tost msg -->
<script src="<?php echo base_url(); ?>assets/toastr/toastr.min.js"></script>
<script src="<?php echo base_url(); ?>assets/toastr/tost.js"></script>
    
    <script type="text/javascript" src="<?php echo base_url() ?>assets/js/myjs/custom.js"></script> 
 <!-- datepicker  -->
 <script src="<?php echo base_url(); ?>assets/js/bootstrap-datepicker.js"></script>
 <script src="<?php echo base_url(); ?>assets/js/bootstrap-datetimepicker.js"></script>
 <script src="https://cdnjs.cloudflare.com/ajax/libs/clockpicker/0.0.7/jquery-clockpicker.min.js" type="text/javascript"></script>
<!-- date formate file -->
