<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
    ...
    <li  class="pull-right">
        <a tabindex="-1" style="height:30px; width:30px; margin-top:10px;padding-top:6px;padding-left:5px;margin-right:20px; margin-left:20px" class="main-link btn-danger btn-sm" href="<?php echo base_url(); ?>" data-toggle="tooltip" title="Logout!">
          <i class="fa fa-power-off fa-sm txt-white"></i>
          
        </a>
    </li>
    <li style="float:right;margin-top:10px;color:#ffffff;" class="pull-right"><div class="profile-user-name"><b>Welcome <?php echo $this->session->userid;?></b></div></li>
    <!-- END PROFILE -->
    <!-- SETTINGS -->
    <!-- <li class="pull-right">
